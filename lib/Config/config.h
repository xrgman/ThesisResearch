...
public:
    ...
    Config(int robotId, int totalNumberRobots, int sampleRate, int numChannelsRaw, int numChannels, bool filterOwnSource, bool printBitsEncoding,
           ...
           double frequencyStopBit, double calibrateSignalEnergyTarget, bool calibrateSignalEnergy, bool testAllRobots, int cellSize)
        : robotId(robotId), totalNumberRobots(totalNumberRobots), sampleRate(sampleRate), numChannelsRaw(numChannelsRaw),
          ...
          calibrateSignalEnergyTarget(calibrateSignalEnergyTarget), calibrateSignalEnergy(calibrateSignalEnergy), testAllRobots(testAllRobots), cellSize(cellSize)
    {
