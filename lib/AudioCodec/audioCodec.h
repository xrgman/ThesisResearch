...
public:
    ...
    ~AudioCodec()
    {
        ...
        free(fft_config_convolve_pre);
        free(fft_config_convolve_pre_inv);
        free(fft_config_convolve_bit);
        free(fft_config_convolve_bit_inv);
    }
...
private:
    ...
    kiss_fft_cfg fft_config_hilbert_pre;
    kiss_fft_cfg fft_config_hilbert_pre_inv;
    kiss_fft_cfg fft_config_hilbert_bit;
    kiss_fft_cfg fft_config_hilbert_bit_inv;

    kiss_fft_cfg fft_config_convolve_pre;
    kiss_fft_cfg fft_config_convolve_pre_inv;
    kiss_fft_cfg fft_config_convolve_bit;
    kiss_fft_cfg fft_config_convolve_bit_inv;
    ...
    void getConvolutionResults(const double *data, const double *symbolData, const int size, double *output, int N, kiss_fft_cfg fft_plan_conv, kiss_fft_cfg fft_plan_conv_inv, FFTConfigStore fftConfigStoreHilbert);
    ...
    // General functions:
    void fftConvolve(const double *in1, const double *in2, const int size, double *output, int N, kiss_fft_cfg fftPlan, kiss_fft_cfg fftPlanInv);
